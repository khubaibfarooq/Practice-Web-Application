...
<html>
    ...
    <center>
         ...
         <form method="post">
             ...
             <input type="date" placeholder="end date" name="end"><br>
...
$db=mysqli_connect('localhost','root','','engineering');
        ...
        $shares = "SELECT od.PID,p.name as name,AVG(od.price) as saleprice,AVG(od.purchaseprice) as pprice,SUM(od.quantity)as quantity FROM order_details as od inner join product as p on od.PID=p.PID where od.date between '$start' and '$end' group by od.PID ";
