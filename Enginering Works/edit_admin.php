...
<html>
    ...
    <center>
            ...
            if(isset($_GET['edit'])){
                ...
                $edit_query = "SELECT * FROM admin WHERE AID = '{$edit_id}' ";
...
<div class="form-group col-sm-1">
    <a href="admin_profile.php" class="btn btn-danger"><<</a>
</div>  


 Name<input type="text" value="<?php echo $edit_name ?>" name="pname" class="form-control" required>
CNIC<input type="text" value="<?php echo $edit_CNIC ?>" name="pCNIC" class="form-control" required>
...
<input type="submit"  name="update" value="update" class="btn btn-info">
 ...
 $db=mysqli_connect('localhost','root','','engineering');
            $edit_update = "UPDATE admin SET name ='$editpname' , CNIC ='$editpCNIC' , address ='$editpaddress', password ='$editppassword',email_id='$editpemail',contact='$contact' WHERE AID = '{$edit_id}' ";
