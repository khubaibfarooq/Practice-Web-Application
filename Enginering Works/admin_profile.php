...
<html>
    ...
    <center>
         <br>
          <?php
            ...
            if(isset($_GET['del'])){
                ...
                $del = "DELETE FROM admin WHERE AID = '{$del_id}' ";
        ...
        <h1 style="color:green"> Manage Admin</h1>
  ...
  $email = $row['email_id'];
    $contact = $row['contact'];
            ...
            <tr>
                ...
                <td><a class='btn btn-info' href="edit_admin.php?edit=<?php echo $id ?>">Update INFO</a></td>

                
                <td><a class='btn btn-danger' href="admin_profile.php?del=<?php echo $id ?>">Delete info</a></td>
